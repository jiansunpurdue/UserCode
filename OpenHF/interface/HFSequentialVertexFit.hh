...
class HFSequentialVertexFit
{
    public:
        ...
        HFSequentialVertexFit(edm::Handle<edm::View<reco::Track> > hTracks, const TransientTrackBuilder *TTB, edm::Handle<reco::VertexCollection> pvCollection, const MagneticField *field, reco::BeamSpot beamSpot, int verbose = 0, bool removeCandTracksFromVtx = true, bool isPbPb_in = false, bool isMC_in = false);
    ...
    private: // instance variables
		...
		bool isMC;    // just used for pbpb, for pbpb data apply decay length cut, but not for MC. for pp not useful
};
