...
//		HFTrackListBuilder(edm::Handle<edm::View<reco::Track> > &hTracks, const TransientTrackBuilder *ttb, int verbose);
        HFTrackListBuilder(edm::Handle<edm::View<reco::Track> > &hTracks, const TransientTrackBuilder *ttb, int verbose, bool isPbPb_in);
	...
	private:
		...
		int fVerbose;
		bool isPbPb; //different track cuts for pp/pPb and pbpb
